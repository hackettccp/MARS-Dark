 ...
 */
    ...
    */
      ...
      // All need to be assigned even if not used by language (no gaps in array)
         ...
         styles[Token.KEYWORD1] = new SyntaxStyle(Color.cyan,false,false);//(Color.black,false,true);
         ...
         styles[Token.LABEL]    = new SyntaxStyle(Color.white,true,false);//(new Color(0x990033),false,true);
